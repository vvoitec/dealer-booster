  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('${process.env.PUBLIC_URL}/lovable-uploads/d74231e7-bd36-408d-9de6-c48d62d8ebbe.png')`,
      ...
      <section 
        className="relative w-full py-16 overflow-hidden"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url('${process.env.PUBLIC_URL}/lovable-uploads/1747c0cf-a44e-4ae9-af60-aae6a929cd54.png')`,
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          backgroundAttachment: 'fixed'
        }}
